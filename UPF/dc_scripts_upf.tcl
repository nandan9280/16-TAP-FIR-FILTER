#====================================
# Final Updated DC Synthesis Script with UPF
#====================================
...
${DESIGN_REF_PATH}/SAED14nm_EDK_STD_RVT/liberty/nldm/dlvl/saed14rvt_dlvl_tt0p8vm40c_i0p8v.db"
...
# Compile Power-Aware with Level Shifter Support
compile -exact_map
...
# Output Files
write -format verilog -hierarchy -output ./fir_filter_netlist.v
write -format ddc -hierarchy -output ./fir_filter.ddc
write_sdc ./fir_filter_gen.sdc

#====================================
# End of Final DC Synthesis Script
#====================================
